...
import edu.asu.ecommerce.dataaccess.Ledger_DAO;
...
public class OrderService {
    ...
    // 2. Add Ledger Entry
    public int addLedgerEntry(String userId, double amount, String transactionType, int orderId) throws Exception {
        LedgerEntry entry = new LedgerEntry(userId, amount, transactionType, orderId, java.time.LocalDate.now());

        int generatedEntryId = ledgerDao.insertLedgerEntry(entry);
